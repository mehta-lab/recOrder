...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cb_orientation_offset = QtWidgets.QCheckBox(self.ReconSettings)
        self.cb_orientation_offset.setText("")
        self.cb_orientation_offset.setObjectName("cb_orientation_offset")
        self.gridLayout_9.addWidget(self.cb_orientation_offset, 11, 1, 1, 1)
